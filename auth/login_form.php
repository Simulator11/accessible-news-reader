...
<head>
    ...
    <style>
        ...
        .btn-success:hover {
            background: linear-gradient(45deg, #1c7430, #155724);
        }
        .toggle-password {
            cursor: pointer;
        }
...
<div class="container d-flex justify-content-center align-items-center" style="height: 100vh;">
    <div class="col-md-5">
        <div class="card">
            ...
            <div class="card-body">
                <form action="login_backend.php" method="POST" onsubmit="return validateForm()">
                ...
                <!-- Signup Link -->
                <p class="mt-3 text-center">Don't have an account? <a href="signup_form.php">Signup</a></p>
            </div>
        </div>
    </div>
</div>
